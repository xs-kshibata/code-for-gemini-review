...
function create_subnav_tab($list){
    ...
    for($i = 0, $size = count($list); $i < $size; ++$i){
        $ary = $list[$i];
        // マニュアルとよくある質問の両方からキーワード検索する場合と、よくある質問のみで検索する場合ではナビゲーションの状態変わる
