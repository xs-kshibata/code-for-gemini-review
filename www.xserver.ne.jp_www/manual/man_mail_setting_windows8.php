...
<title>Windows8メール設定手順 | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="レンタルサーバー「エックスサーバー」のご利用マニュアル｜サーバーパネルで作成したメールアドレスを「Windows8メール」で使用するための設定手順について記載しています。">
            ...
            <section class="col-main">
				...
				<p class="toc-list--head">目次</p>
					<ul class="toc-list--body">
						<li><a href="#link-a">Windows8 メールアプリでの設定方法(Microsoftアカウントが、メールアプリで設定するメールアドレスと同一の場合)</a>
							<ul>
						...
						<li><a href="#link-b">メールアカウントを初めて追加設定する場合</a>
							<ol>
								<li><a href="#link-b01">1.アカウントを追加</a></li>
								<li><a href="#link-b02">2.「その他のアカウント」をクリック</a></li>
								<li><a href="#link-b03">3.IMAPを選択</a></li>
								<li><a href="#link-b04">4.メールアドレスとパスワードを入力</a></li>
								<li><a href="#link-b05">5.情報の入力</a></li>
							</ol>
						</li>
						<li><a href="#link-c">既にメールアカウントを追加設定されている場合</a>
							<ol>
								<li><a href="#link-c01">1.アカウントを追加</a></li>
								<li><a href="#link-c02">2.設定の中の「アカウント」をクリック</a></li>
								<li><a href="#link-c03">3.「アカウント」の追加をクリック</a></li>
								<li><a href="#link-c04">4.「その他のアカウント」を選択</a></li>
								<li><a href="#link-c05">5.IMAPを選択</a></li>
								<li><a href="#link-c06">6.メールアドレスとパスワードを入力</a></li>
								<li><a href="#link-c07">7.情報の入力</a></li>
							</ol>
						</li>
						<li><a href="#link-d">SMTP認証設定方法</a>
							<ol>
								...
								<li><a href="#link-d04">4.「送信サーバーは認証が必要」にチェック</a></li>
							</ol>
						</li>
					</ul>
				</div>
                ...
                <section class="section">
                    ...
                    <h4 class="section_ttl" id="link-a">Windows8 メールアプリでの設定方法<span class="font-xs">(Microsoftアカウントが、メールアプリで設定するメールアドレスと同一の場合)</span></h4>
                    <div class="section_body">

						<p>
							Windows 8のメールアプリの受信形式は、IMAPのみに対応しています。<br>
							受信形式をPOPで利用したい場合は、他のメールソフトをご用意ください。
						</p>
						<p>メールアプリに設定するメールアドレスが、Microsoftアカウントと異なる場合は、以下のマニュアルをご参照ください。</p>

						<div class="border border_gray">
							<p class="link mb0"><i class="ico ico_square-fill"></i>関連：<a href="man_mail_setting_windows8_not_mail_app.php">Microsoftアカウントがメールアプリで設定するメールアドレスと異なる場合</a><i class="ico ico_chevron-right"></i></p>
						</div>
                        
                        <section class="block mt50">
                            <h5 class="block_ttl" id="link-a01">起動時の操作</h5>
                ...
                <section class="section">
                    ...
                    <div class="section_body">
                        ...
                        <div class="serial-box">
                            <section class="box">
                                <h5 class="box_ttl" id="link-b01">1.アカウントを追加</h5>
                                <div class="box_body">
                                    <p>「受信トレイの準備中に別のアカウントを追加しますか？」の『はい』をクリックしてください。</p>
                                    <p><img class="img" src="../img/manual/man_mail_setting_windows8_3.png" alt="『はい』をクリックしているスクリーンショット"></p>
                                </div>
                            </section>
                            <section class="box">
                                <h5 class="box_ttl" id="link-b02">2.「その他のアカウント」をクリック</h5>
                                <div class="box_body">
                                    <p><img class="img" src="../img/manual/man_mail_setting_windows8_4.png" alt="「その他のアカウント」をクリックしているスクリーンショット"></p>
                                </div>
                            </section>
                            <section class="box">
                                <h5 class="box_ttl" id="link-b03">3.IMAPを選択</h5>
                                <div class="box_body">
                            ...
                            <section class="box">
                                <h5 class="box_ttl" id="link-b04">4.メールアドレスとパスワードを入力</h5>
                                <div class="box_body">
                            ...
                            <section class="box">
                                <h5 class="box_ttl" id="link-b05">5.情報の入力</h5>
                                <div class="box_body">
                ...
                <section class="section">
                    ...
                    <div class="section_body">                   
                        <div class="serial-box">
                            <section class="box">
                                <h5 class="box_ttl" id="link-c01">1.アカウントを追加</h5>
                                <div class="box_body">
                                    <p>マウスポインタを画面右下に移動させ、表示されたチャーム(黒帯部分)にある「設定」をクリックしてください。</p>
                                    <p><img class="img" src="../img/manual/man_mail_setting_windows8_8.png" alt="「設定」をクリックしているスクリーンショット"></p>
                                </div>
                            </section>
                            <section class="box">
                                <h5 class="box_ttl" id="link-c02">2.設定の中の「アカウント」をクリック</h5>
                                <div class="box_body">
                                    <p><img class="img" src="../img/manual/man_mail_setting_windows8_9.png" alt="「アカウント」をクリックしているスクリーンショット"></p>
                                </div>
                            </section>
                            <section class="box">
                                <h5 class="box_ttl" id="link-c03">3.「アカウント」の追加をクリック</h5>
                                <div class="box_body">
                                    <p><img class="img" src="../img/manual/man_mail_setting_windows8_10.png" alt="「アカウント」の追加をクリックしているスクリーンショット"></p>
                                </div>
                            </section>
                            <section class="box">
                                <h5 class="box_ttl" id="link-c04">4.「その他のアカウント」を選択</h5>
                                <div class="box_body">
                                    <p><img class="img" src="../img/manual/man_mail_setting_windows8_4.png" alt="「詳細を表示」をクリックしているスクリーンショット"></p>
                                </div>
                            </section>
                            <section class="box">
                                <h5 class="box_ttl" id="link-c05">5.IMAPを選択</h5>
                                <div class="box_body">
                                    <p>「IMAP」を選択し、『接続』をクリックしてください。</p>
                                    <p><img class="img" src="../img/manual/man_mail_setting_windows8_5.png" alt="『接続』をクリックしているスクリーンショット"></p>
                                </div>
                            ...
                            <section class="box">
                                <h5 class="box_ttl" id="link-c06">6.メールアドレスとパスワードを入力</h5>
                                <div class="box_body">
                                    <p>追加設定希望のメールアドレス、メールアドレス作成時に設定したパスワードを入力し、「詳細を表示」をクリックしてください。</p>
                                    <p><img class="img" src="../img/manual/man_mail_setting_windows8_6.png" alt="「詳細を表示」をクリックしているスクリーンショット"></p>
                                </div>
                            ...
                            <section class="box">
                                <h5 class="box_ttl" id="link-c07">7.情報の入力</h5>
                                <div class="box_body">
                                    <p>下記を参考に情報を入力し、「接続」をクリックしてください。</p>
                                    <p><img class="img" src="../img/manual/man_mail_setting_windows8_7.png" alt="「接続」をクリックしているスクリーンショット"></p>
                                    <table class="table mb5">
                ...
                <section class="section">
                    ...
                    <div class="serial-box">
                        ...
                        <section class="box">
                            ...
                            <h5 class="box_ttl" id="link-d04">4.「送信サーバーは認証が必要」にチェック</h5>
                            <div class="box_body">
