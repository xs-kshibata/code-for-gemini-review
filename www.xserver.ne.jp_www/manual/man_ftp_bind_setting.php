...
<title>BiND for WebLiFE 8設定手順 | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="レンタルサーバー「エックスサーバー」のご利用マニュアル｜「BiND for WebLiFE 8」を用いてご契約中のサーバーアカウントへFTP接続をするための設定手順について記載しています。">
...
<?php include("subnav.php"); ?>
        ...
        <div class="clearfix">
            ...
            <section class="col-main">
                ...
                <h3 class="sub-ttl">BiND for WebLiFE 8の設定</h3>
                
				<div class="toc-list">
				<p class="toc-list--head">目次</p>
				<ul class="toc-list--body">
					<li><a href="#link-a">BiND for WebLiFE 8の設定</a>
						<ol>
							<li><a href="#link-a01">1.「サイト設定」をクリック</a></li>
							<li><a href="#link-a02">2.「サーバー設定」</a></li>
                ...
                <section class="section">
                    <h4 class="section_ttl" id="link-a">BiND for WebLiFE 8の設定</h4>
                    <div class="section_body">
                        <div class="serial-box">
                            <section class="box">
                                <h5 class="box_ttl" id="link-a01">1.「サイト設定」をクリック</h5>
                                <div class="box_body">
                                    <p>BiND for WebLiFE 8を起動し、画面右上の「サイト設定」をクリックしてください。</p>
                                    <p><img class="img" src="../img/manual/man_ftp_bind_setting_1.png" alt="BiND for WebLiFEでサイト設定を選択しているスクリーンショット"></p>
                                </div>
                            </section>
                            <section class="box">
                                <h5 class="box_ttl" id="link-a02">2.「サーバー設定」</h5>
                                <div class="box_body">
                                    <p>「サイト設定」の「サーバー設定」画面で、「サーバーの種類」に「一般的なFTPサーバー」を選択してください。</p>
                                    <p><img class="img" src="../img/manual/man_ftp_bind_setting_2.png" alt="BiND for WebLiFEでFTPの設定を選択しているスクリーンショット"></p>
                                </div>
                            </section>
                            <section class="box">
                                <h5 class="box_ttl" id="link-a03">3.FTP情報を入力</h5>
                                <div class="box_body">
                                    <p>下記のように各項目を入力後、「テスト開始」をクリックしてください。</p>
                                    ...
                                    <table class="table table_use-caption">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th class="w20per">サーバーの種類</th>
                                                <td>「一般的なFTPサーバー」を選択してください。</td>
                                            </tr>
                                            <tr>
                                                <th>サイトURL</th>
                                    ...
                                    <p><img class="img" src="../img/manual/man_ftp_bind_setting_3.png" alt="BiND for WebLiFEでメインFTPアカウントで設定しているスクリーンショット"></p>
                                </div>
                            </section>
                            <section class="box">
                                <h5 class="box_ttl" id="link-a04">4.設定完了</h5>
                                <div class="box_body">
                                    <p>「接続テストに成功しました。」と表示されたら「OK」をクリックして設定完了です。</p>
                                    
                                    <p><img class="img" src="../img/manual/man_ftp_bind_setting_4.png" alt="BiND for WebLiFEの設定が完了したスクリーンショット"></p>
                                </div>
                            </section>
                        </div>
                        <!-- /.serial-box -->
                    ...
                    <div class="section_body">
                        ...
                        <table class="table table_use-caption">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>パスワード</th>
                                    <td>サブFTPアカウント追加時にお客様にて決めたパスワードを入力してください。</td>
                                </tr>
                                <tr>
                                    <th>サーバーディレクトリ</th>
                                    <td>アップロード先ドメインのドキュメントルート以下を設定してください。<br>
                        ...
                        <p><img class="img" src="../img/manual/man_ftp_bind_setting_5.png" alt="BiND for WebLiFEでサブFTPアカウントで設定しているスクリーンショット"></p>
