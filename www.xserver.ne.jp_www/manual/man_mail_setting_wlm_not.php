...
<title>WindowsLiveメール(接続の保護なし)設定手順 | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="レンタルサーバー「エックスサーバー」のご利用マニュアル｜サーバーパネルで作成したメールアドレスを「WindowsLiveメール」で使用するための設定手順について。「接続時にSSLを利用しない（接続の保護なし）」設定の手順を記載しています。">
            ...
            <section class="col-main">
				...
				<p class="toc-list--head">目次</p>
					<ul class="toc-list--body">
						<li><a href="#link-a">WindowsLiveメール アカウントの設定方法</a>
							<ol>
								...
								<li><a href="#link-a03">4.設定完了</a></li>
							</ol>
						</li>
                ...
                <section class="section">
                    <h4 class="section_ttl" id="link-a">WindowsLiveメール アカウントの設定方法</h4>
                    <div class="section_body">
                        ...
                        <div class="border border_gray">
                            <p class="link mb0"><a href="man_mail_setting_wlm.php">「STARTTLS」あるいは「POP/IMAP/SMTP over SSL」を利用する場合はこちら</a><i class="ico ico_chevron-right"></i></p>
                        </div>
                        ...
                        <div class="serial-box">
                            ...
                            <section class="box">
                                ...
                                <div class="box_body">
                                    ...
                                    <p><img class="img" src="../img/manual/man_mail_setting_wlm_5.png" alt="受信・送信メールサーバーを記入"></p>
                                    ...
                                    <aside class="msg msg_caution">
                                        ...
                                        <div class="msg_body">
                                            <p>overSSLを利用する場合は「セキュリティで保護された接続（SSL）が必要（R)」にチェックを入れ、受信メールサーバー、送信メールサーバー、ポート番号を<a href="man_mail_setting.php">メールソフトの設定</a>を参考に入力してください。</p>
                                        </div>
                                    </aside>
