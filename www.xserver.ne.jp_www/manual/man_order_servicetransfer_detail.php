...
<title>XServerビジネスへの変更 仕様詳細 | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="レンタルサーバー「エックスサーバー」のご利用マニュアル｜エックスサーバーからXServerビジネスへのサービス変更に伴うデータコピーや、サーバ切替時に実行している動作のご案内です。">
...
<?php include("subnav.php"); ?>
        ...
        <div class="clearfix">
            ...
            <section class="col-main">
                ...
                <h3 class="sub-ttl">XServerビジネスへの変更 仕様詳細</h3>
                ...
                <p>XServerビジネスへの変更によるデータコピー、サーバー切り替えの仕様詳細をご案内いたします。</p>
                    ...
                    <div class="section_body">
                        ...
                        <section class="block">
                            ...
                            <div class="block_body">
                                ...
                                確認方法は、マニュアル「<a href="man_order_servicetransfer_flow.php#link-c">XServerビジネスへの変更 ご利用手順 &#8250; 動作確認</a>」をご参照ください。</p>
                ...
                <section class="section">
                    ...
                    <div class="section_body">
                        ...
                        <section class="block">
                            <h5 class="block_ttl" id="link-b01">新しいサーバー環境における修正項目</h5>
                            <div class="block_body">
                                <dl class="dl">
