...
<title>Outlook 2007設定手順 | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="レンタルサーバー「エックスサーバー」のご利用マニュアル｜サーバーパネルで作成したメールアドレスを「Outlook 2007」で使用するための設定手順について。overSSL設定の手順を記載しています。">
            ...
            <section class="col-main">
				...
				<p class="toc-list--head">目次</p>
					<ul class="toc-list--body">
						<li><a href="#link-a">Microsoft Outlook 2007 の設定方法(overSSL設定)</a>
							<ol>
								...
								<li><a href="#link-a06">6.詳細設定</a></li>
								<li><a href="#link-a07">7.アカウント設定のテスト</a></li>
                ...
                <section class="section">
                    ...
                    <h4 class="section_ttl" id="link-a">Microsoft Outlook 2007 の設定方法(overSSL設定)</h4>
                    <div class="section_body">

                        <div class="border border_gray">
                            <p class="link mb0"><a href="man_mail_setting_ol_not.php">「接続時にSSLを利用しない（接続の保護なし）」場合はこちら</a><i class="ico ico_chevron-right"></i></p>
                        </div>
                        ...
                        <div class="serial-box">
                            ...
                            <section class="box">
                                ...
                                <div class="box_body">
                                    <p>下記を参考に情報を入力し、「詳細設定(M)」にお進みください。</p>
                            ...
                            <section class="box">
                                <h5 class="box_ttl" id="link-a06">6.詳細設定</h5>
                                <div class="box_body">
                                	<ol class="ol">
                                        <li>
                                        <p>「インターネット電子メール設定」画面の［送信サーバー］タブに進みます。<br>
                                        「送信サーバー（SMTP）は認証が必要（O）」にチェックを入れ、「受信メールサーバーと同じ設定を使用する（U）」をご選択ください。</p>
                                        <p><img class="img" src="../img/manual/man_mail_setting_ol_6.png" alt="「インターネット電子メール設定」画面"></p>
                                        </li>
                                        
                                        <li>
                                        <p>「インターネット電子メール設定」画面の［詳細設定］タブに進みます。<br>
                                        下記を参考に情報を入力後、「OK」のボタンを押してください。</p>
                                        <p><img class="img" src="../img/manual/man_mail_setting_ol_7.png" alt="「インターネット電子メール設定」画面"></p>
                                        </li>
                                    </ol>
                                    ...
                                    <table class="table table_use-caption mb10">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th class="w40per">受信サーバー（POP3）（I）</th>
                            ...
                            <section class="box">
                                <h5 class="box_ttl" id="link-a07">7.アカウント設定のテスト</h5>
                                <div class="box_body">
                                    <p>「インターネット電子メール設定」画面で「[次へ]ボタンをクリックしたらアカウント設定をテストする（Ｓ）」にチェックを入れ、「次へ（N）」をクリックします。すると、アカウント設定のテストが開始されます。</p>
                                    <p><img class="img" src="../img/manual/man_mail_setting_ol_5.png" alt="設定完了"></p>
                                </div>
                            </section>
                            <section class="box">
                                ...
                                <div class="box_body">
                                    ...
                                    <p><img class="img" src="../img/manual/man_mail_setting_ol_9.png" alt="設定完了"></p>
                ...
                <section class="section">
                    ...
                    <div class="serial-box">
                        ...
                        <section class="box">
                            ...
                            <div class="box_body">
                                <p>「電子メール」タブより、メールアカウントを選択し、「変更(A)」をクリックします。</p>
