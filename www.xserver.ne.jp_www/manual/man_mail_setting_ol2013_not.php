...
<title>Outlook 2013(接続の保護なし)設定手順 | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="レンタルサーバー「エックスサーバー」のご利用マニュアル｜サーバーパネルで作成したメールアドレスを「Outlook 2013」で使用するための設定手順について。「接続時にSSLを利用しない（接続の保護なし）」設定の手順を記載しています。">
            ...
            <section class="col-main">
				...
				<p class="toc-list--head">目次</p>
					<ul class="toc-list--body">
						<li><a href="#link-a">Microsoft Outlook 2013 アカウントの設定方法</a>
							<ol>
                ...
                <section class="section">
                    <h4 class="section_ttl" id="link-a">Microsoft Outlook 2013 アカウントの設定方法</h4>
                    <div class="section_body">
                        ...
                        <div class="border border_gray">
                            <p class="link mb0"><a href="man_mail_setting_ol2013.php">「STARTTLS」あるいは「POP/IMAP/SMTP over SSL」を利用する場合はこちら</a><i class="ico ico_chevron-right"></i></p>
                        </div>
                        ...
                        <div class="serial-box">
                            <section class="box">
                                ...
                                <div class="box_body">
                                    <dl class="dl">
                                        <dt><i class="ico ico_square-fill"></i>「Microsoft Outlook 2013 スタートアップ」が表示される場合</dt>
                                        <dd>
                                            <p class="note">※表示されていない場合は、<a class="font-bold" href="#next">「Microsoft Outlook 2013 スタートアップ」が表示されない場合</a>の手順から進めてください。</p>
                                    ...
                                    <dl class="dl">
                                        <dt id="next"><i class="ico ico_square-fill"></i>「Microsoft Outlook 2013 スタートアップ」が表示されない場合</dt>
                                        <dd>
                                            <p>「ファイル」タブをクリックします。</p>
                                ...
                                <div class="box_body">
                                    ...
                                    <ol class="ol">
                                        ...
                                        <li>
                                            ...
                                            <p><img class="img" src="../img/manual/man_mail_setting_ol2013_14.png" alt="「インターネット電子メール設定」画面の「詳細設定」タブ"></p>
