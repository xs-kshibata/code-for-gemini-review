...
<title>ローソンでのお支払い | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="レンタルサーバー「エックスサーバー」のご利用料金をローソンで支払うための手順です。">
...
<?php include("subnav.php"); ?>
        ...
        <div class="clearfix">
            ...
            <section class="col-main">
                ...
                <h3 class="sub-ttl pb10">ローソン<i class="imgico imgico_lawson ml10"></i></h3>
                
                <p>お客様の「XServerアカウント」よりお支払い手続きを行われましたサーバーや独自ドメインのご利用料金は、お近くのローソン店頭で現金にてお支払いいただけます。</p>
                <p class="note">※コンビニ店頭での変更・払戻しはできませんので、予めご了承ください。</p>
                <p class="mb40"><a class="btn btn_gray" href="http://store.lawson.co.jp/" target="_blank" rel="nofollow">ローソン店舗検索<i class="ico ico_new-window"></i></a></p>
                ...
                <div class="flow">
                    ...
                    <section class="flow_item">
                        ...
                        <p class="note">※ローソン店頭でお支払いする際に必要となります。</p>
                    </section>
                    <section class="flow_item">
                        <h4 class="flow_ttl">お近くのローソンへ</h4>
                        <p>ローソン店内に設置されているLoppi （情報端末）を用いて、レジで支払う際に必要な「申込券」を入手してください。</p>
