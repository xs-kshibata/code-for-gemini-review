...
$subnav_list = array(
    array( "label" => "料金プラン", "filename" => "price/index.php", "classname" => "suvnav_item_label suvnav_item_label_price" ),
    //array( "label" => "ドメイン", "filename" => "domain/", "classname" => "suvnav_item_label suvnav_item_label_price_domain" ),
    array(
        "label" => "お支払い方法",
        "filename" => array(
            "price/price_payment_method.php",
            "price/price_payment_method_credit.php",
            "price/price_payment_method_bank.php",
            "price/price_payment_method_pay_easy.php",
            "price/price_payment_method_paidy.php",
            "price/price_payment_method_prepaid.php",
            "price/price_payment_method_seven.php",
            "price/price_payment_method_lawson.php",
            "price/price_payment_method_daily.php",
            "price/price_payment_method_mini.php",
            "price/price_payment_method_family.php",
            "price/price_payment_method_seicomart.php",
            "price/price_payment_method_circle.php",
            "price/price_payment_method_receipt.php"
        ),
        "classname" => "suvnav_item_label suvnav_item_label_price_payment_method"
    ),
	array( "label" => "独自SSL", "filename" => "price/price_ssl.php", "classname" => "suvnav_item_label suvnav_item_label_price_ssl" ),
	array( "label" => "設定おまかせサポート", "filename" => "price/service_daiko.php", "classname" => "suvnav_item_label suvnav_item_label_service_daiko" ),
	array( "label" => "サーバー移転代行", "filename" => "price/service_server_daiko.php", "classname" => "suvnav_item_label suvnav_item_label_service_server_daiko" ),
);
