...
$subnav_list = array(
    array( "label" => "XServerアカウント", "filename" => "login_info.php", "classname" => "suvnav_item_label suvnav_item_label_login_info" ),
    array( "label" => "サーバーパネル", "filename" => "login_server.php", "classname" => "suvnav_item_label suvnav_item_label_login_server" ),
    array( "label" => "ファイルマネージャ", "filename" => array("login_file.php", "login_file_old.php"), "classname" => "suvnav_item_label suvnav_item_label_login_file" ),
    array( "label" => "WEBメール", "filename" => "login_mail.php", "classname" => "suvnav_item_label suvnav_item_label_login_mail" ),
);
