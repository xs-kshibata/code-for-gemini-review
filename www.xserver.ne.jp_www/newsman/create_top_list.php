...
?>
<dl class="headlines_box clearfix">
    <dt class="headlines_box_date"><i class="ico ico_circle-right"></i><?php secure_print($key); ?></dt>
    <dd class="headlines_box_list">
        <ul>
<?php
foreach ($f as $ff) {
?>
<li><?php if($ff['content'] != "") { ?><a href="information_detail.php?view_id=<?php print $ff['id']; ?>"><?php } ?>
<?php
if($ff['title']){
