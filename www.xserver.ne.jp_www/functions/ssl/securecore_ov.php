...
<title>クラウドセキュア 企業認証SSL - 独自SSL | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="クラウドセキュア 企業認証SSLの仕様詳細とご利用料金に関するご案内です。">
...
<?php include("../subnav.php"); ?>
        ...
        <p class="tac mb30"><a href="<?php print $SITE_URL; ?>campaign/campaign_250430.php"><img class="hover fluid-sm" src="<?php print $SITE_URL; ?>img/campaign/250430/cp_bnr.png?date=20250626" alt="SSL証明書 最大20%OFFキャンペーン"></a></p>


        <div class="ssl-brand">
            <div class="ssl-brand-header clearfix">
                <div class="ssl-brand-header_r">
                    <img src="../../img/functions/img_logo_securecore.png?date=20250626" alt="クラウドセキュア">
                </div>
                <div class="ssl-brand-header_l">
                    <h3 class="ssl-brand-header_ttl">クラウドセキュア 企業認証SSL</h3>
                    <div class="ssl-brand-header_auth">
                        <div class="ssl-brand-header_auth_ttl">認証タイプ</div>
                        <div class="ssl-brand-header_auth_body"><img src="../../img/functions/img_auth_level_2.png" alt="2">企業認証</div>
                    </div>
                    <p class="mb0">企業の実在を証明することで、サイトの信頼性をより高めることができるSSL証明書です。<br>
                        企業サイトの運営や、重要な個人情報を入力するフォームに適しています。</p>
                </div>
            </div>
            ...
            <div class="ssl-brand-price">
                <div class="ssl-brand-price_more">
                    <dl class="pr-price">
                        <dt>年額</dt>
                        <dd>
                            <span>33,000</span>円(税込)〜
                            <span class="cpPrice">キャンペーン価格：26,400円〜※</span>
                        </dd>
                    </dl>
                </div>
            </div>

            <p class="note font-s mb30">※2025年4月30日12:00 - 2025年9月30日17:00までのキャンペーン価格です。</p>
            
            <div class="ssl-brand-feature">
                <h4 class="ssl-brand-feature_ttl">クラウドセキュア 企業認証SSLの特長</h4>
                <div class="ssl-brand-feature_pr clearfix">
                    <ul>
                        ...
                        <li><dl><dt><img src="../../img/functions/ico_ssl_reliability.png" alt=""></dt><dd><b>サイトの信頼性アップ！</b><br>組織の実在性を証明することで、運営サイトの信頼性を向上</dd></dl></li>
                        <li><dl><dt><img src="../../img/functions/ico_ssl_securityl.png" alt=""></dt><dd><b>セキュリティ診断対応！</b><br>マルウェアなどサイト上の脅威を検知。追加費用なしでご利用可能です。</dd></dl></li>
                    </ul>
                </div>
            </div>
        ...
        <section class="section">
            ...
            <div class="section_body">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>発行に要する日数(※1)</th>
                        <td>最短1営業日（通常：1-4日営業日）</td>
                    </tr>
                    <tr>
                        <th>セキュリティ診断</th>
                        <td><span class="font22">○</span><br>
                        <p class="mt5"><a class="btn btn_white btn_white_border" href="#security-diagnosis">セキュリティ診断について<i class="ico ico_chevron-down"></i></a></p>
                        </td>
                    </tr>
                    <tr>
                        <th>サイトシール</th>
                        <td><img src="../../img/functions/img_siteseal_securecore_upgrade.png?date=20250626" class="flex" alt="クラウドセキュア サイトシールサンプル"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="ssl-table_inner"><a class="btn btn_white btn_white_border" href="https://www.securecore.co.jp/ssl/sslcert/domaincert.php" target="_blank" rel="nofollow">その他OSや端末の対応状況<i class="ico ico_new-window"></i></a></p>
                        </td>
                    </tr>
                </table>
                <!-- /.ssl-table -->
                ...
                <p class="note">※取得したSSLサーバー証明書は当社の対応サービスでのみ設定可能です。<br>また、当社の対応サービス以外で取得した証明書はご利用いただけません。</p>
		...
		<section id="security-diagnosis" class="mb30">
            ...
            <div class="security-diagnosis_inner">
                ...
                <div class="security-diagnosis_desc">
                    ...
                    <p class="mb20">SSLによる実在証明と暗号化が当たり前になった今、このようなセキュリティ診断対応のSSL証明書を選択することで、サイトセキュリティのさらなる向上に取り組んでみてはいかがでしょうか。</p>
                </div>
                <!-- security-diagnosis_desc -->

                <div class="security-diagnosis_secure_ttl clearfix">
                    <p>エックスサーバーがおすすめする「セキュリティ診断」対応SSL証明書</p>
                ...
                <div class="security-diagnosis_secure_desc clearfix">
                    <div class="security-diagnosis_secure_desc_left">
                        ...
                        <p class="note font14">※特定のURLを起点とした既定のページ数の診断を毎日行います。詳細は<a href="https://www.securecore.co.jp/" target="_blank">クラウドセキュア公式サイト</a><i class="ico ico_new-window"></i>をご確認ください。</p>
                    </div>
                ...
                <div class="security-diagnosis_lineup">
                    ...
                    <ul class="security-diagnosis_lineup_list">
                        <li>
                            <a href="securecore.php" class="btn btn--primary">クラウドセキュア スピード認証SSL<br><span>認証レベル</span><img src="../../img/functions/img_securecore_ssllevel_1.png" alt="1"> <i class="ico ico_chevron-right"></i></a>
                        </li>
                        <li>
                            <a href="securecore_ov.php" class="btn btn--primary"><span class="now dv">現在のページ</span>クラウドセキュア 企業認証SSL<br><span>認証レベル</span><img src="../../img/functions/img_securecore_ssllevel_2.png" alt="2"> <i class="ico ico_chevron-right"></i></a>
                        </li>
                        <li>
                            <a href="securecore_ev.php" class="btn btn--primary">クラウドセキュア EV SSL<br><span>認証レベル</span><img src="../../img/functions/img_securecore_ssllevel_3.png" alt="3"> <i class="ico ico_chevron-right"></i></a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="section_body">
                <section class="block">
                    ...
                    <div class="block_body">
                        <p>初回にお支払いいただく年間のご利用料金は以下の通りです。</p>
                        ...
                        <table class="table yearPriceTable primary-table-l">
                            ...
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">41,800円</div><span class="numYears__price--num">33,440</span>円</div><div class="numYears__period">×1年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">41,800円</div><span class="numYears__price--num">33,440</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">38,500円</div><span class="numYears__price--num">30,800</span>円</div><div class="numYears__period">×2年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">77,000円</div><span class="numYears__price--num">61,600</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">36,300円</div><span class="numYears__price--num">29,040</span>円</div><div class="numYears__period">×3年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">108,900円</div><span class="numYears__price--num">87,120</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">35,200円</div><span class="numYears__price--num">28,160</span>円</div><div class="numYears__period">×4年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">140,800円</div><span class="numYears__price--num">112,640</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">33,000円</div><span class="numYears__price--num">26,400</span>円</div><div class="numYears__period">×5年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">165,000円</div><span class="numYears__price--num">132,000</span>円</div></div></td>
                            </tr>
                            </tbody>
                        </table>
                        <p class="note mb5">
                ...
                <section class="block">
                    ...
                    <div class="block_body">
                        <p>更新時にお支払いいただく年間のご利用料金は以下の通りです。</p>
                        <p class="font-s fr mb0">(税込)</p>
                        <table class="table yearPriceTable primary-table-l">
                            <thead>
                            <tr>
                            ...
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">1</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">41,800</span>円</div><div class="numYears__period">×1年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">41,800</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">2</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">38,500</span>円</div><div class="numYears__period">×2年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">77,000</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">3</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">36,300</span>円</div><div class="numYears__period">×3年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">108,900</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">4</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">35,200</span>円</div><div class="numYears__period">×4年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">140,800</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">5</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">33,000</span>円</div><div class="numYears__period">×5年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">165,000</span>円</div></div></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <p class="tac mb40"><a class="btn btn_black-l" href="../../manual/man_order_ssl.php">お申し込みの手順を確認する</a></p>
