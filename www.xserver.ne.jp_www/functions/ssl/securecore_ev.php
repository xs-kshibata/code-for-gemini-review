...
<title>クラウドセキュア EV SSL - 独自SSL | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="クラウドセキュア EV SSLの仕様詳細とご利用料金に関するご案内です。">
        ...
        <div class="ssl-brand">
            <div class="ssl-brand-header clearfix">
                ...
                <div class="ssl-brand-header_l">
                    <h3 class="ssl-brand-header_ttl">クラウドセキュア EV SSL</h3>
                    <div class="ssl-brand-header_auth">
                        <div class="ssl-brand-header_auth_ttl">認証タイプ</div>
                        <div class="ssl-brand-header_auth_body"><img src="../../img/functions/img_auth_level_3.png" alt="3">EV</div>
                    </div>
                    <p class="mb0">
                        世界標準の厳格な認証プロセスにより、最も高い信頼性を備える証明書です。<br>
            ...
            <div class="ssl-brand-price">
                <div class="ssl-brand-price_more">
                    <dl class="pr-price">
                        <dt>年額</dt>
                        <dd>
                            <span>83,600</span>円(税込)〜
                            <span class="cpPrice">キャンペーン価格：66,880円〜※</span>
                        </dd>
                    </dl>
                </div>
            </div>
            ...
            <div class="ssl-brand-feature">
                <h4 class="ssl-brand-feature_ttl">クラウドセキュア EV SSLの特長</h4>
                <div class="ssl-brand-feature_pr clearfix">
                    <ul>
                        ...
                        <li><dl><dt><img src="../../img/functions/ico_ssl_reliability.png" alt=""></dt><dd><b>サイトの信頼性アップ！</b><br>組織の実在性を最も厳格に審査することで、より高い信頼性を実現</dd></dl></li>
        ...
        <section class="section">
            ...
            <div class="section_body">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>対応ブラウザ・スマートフォン(※2) <br>独自IPアドレスなし</th><td>
            ...
            <div class="security-diagnosis_inner">
                ...
                <div class="security-diagnosis_lineup">
                    ...
                    <ul class="security-diagnosis_lineup_list">
                        ...
                        <li>
                            <a href="securecore_ov.php" class="btn btn--primary">クラウドセキュア 企業認証SSL<br><span>認証レベル</span><img src="../../img/functions/img_securecore_ssllevel_2.png" alt="2"> <i class="ico ico_chevron-right"></i></a>
                        </li>
                        <li>
                            <a href="securecore_ev.php" class="btn btn--primary"><span class="now dv">現在のページ</span>クラウドセキュア EV SSL<br><span>認証レベル</span><img src="../../img/functions/img_securecore_ssllevel_3.png" alt="3"> <i class="ico ico_chevron-right"></i></a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="block_body">
                        ...
                        <table class="table yearPriceTable primary-table-l">
                            ...
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">105,600円</div><span class="numYears__price--num">84,480</span>円</div><div class="numYears__period">×1年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">105,600円</div><span class="numYears__price--num">84,480</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">99,000円</div><span class="numYears__price--num">79,200</span>円</div><div class="numYears__period">×2年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">198,000円</div><span class="numYears__price--num">158,400</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">93,500円</div><span class="numYears__price--num">74,800</span>円</div><div class="numYears__period">×3年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">280,500円</div><span class="numYears__price--num">224,400</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">89,100円</div><span class="numYears__price--num">71,280</span>円</div><div class="numYears__period">×4年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">356,400円</div><span class="numYears__price--num">285,120</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">83,600円</div><span class="numYears__price--num">66,880</span>円</div><div class="numYears__period">×5年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">418,000円</div><span class="numYears__price--num">334,400</span>円</div></div></td>
                            </tr>
                            </tbody>
                        </table>
                        <p class="note mb5">
                ...
                <section class="block">
                    ...
                    <div class="block_body">
                        ...
                        <table class="table yearPriceTable primary-table-l">
                            ...
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">1</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">105,600</span>円</div><div class="numYears__period">×1年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">105,600</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">2</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">99,000</span>円</div><div class="numYears__period">×2年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">198,000</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">3</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">93,500</span>円</div><div class="numYears__period">×3年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">280,500</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">4</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">89,100</span>円</div><div class="numYears__period">×4年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">356,400</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">5</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">83,600</span>円</div><div class="numYears__period">×5年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">418,000</span>円</div></div></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
