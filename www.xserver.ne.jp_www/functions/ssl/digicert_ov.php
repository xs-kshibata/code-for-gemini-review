...
<title>デジサート セキュア・サーバID - 独自SSL | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="デジサート セキュア・サーバIDの仕様詳細とご利用料金に関するご案内です。">
        ...
        <div class="ssl-brand">
            <div class="ssl-brand-header clearfix">
                <div class="ssl-brand-header_r">
                    <img src="../../img/functions/img_logo_digicert.png" alt="クラウドSSL">
                </div>
                <div class="ssl-brand-header_l">
                    <h3 class="ssl-brand-header_ttl">デジサート セキュア・サーバID</h3>
            ...
            <div class="ssl-brand-price">
                <div class="ssl-brand-price_more">
                    <dl class="pr-price"><dt>年額</dt><dd><span>80,300</span>円(税込)〜
                            <span class="cpPrice">キャンペーン価格：64,240円〜※</span>
                        </dd></dl>
                </div>
            </div>
            ...
            <div class="ssl-brand-feature">
                <h4 class="ssl-brand-feature_ttl">デジサート セキュア・サーバIDの特長</h4>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><span class="font22">○</span><br>
                            <p class="mt5">DigiCert（デジサート）のセキュリティ機能「<a href="https://www.websecurity.digicert.com/ja/jp/security-topics/malware-scanning" target="_blank">マルウェアスキャン</a>」<i class="ico ico_new-window"></i>が付属しています。</p>
                        </td>
                    </tr>
                    <tr>
                        <th>サイトシール</th>
                        <td><img src="../../img/functions/img_siteseal_digicert.png?date=231017" width="150" height="auto" class="flex" alt="サイトシールサンプル"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <dl class="ssl-table_dl">
                                ...
                                <dd>
                                    <i class="ssl-table_mark imgico imgico_circle"></i>
                                    IE:6以降、Firefox:10.0以降、GoogleChrome:1.0以降、Safari:3.1以降
                                </dd>
                            </dl>
                            <dl class="ssl-table_dl">
                                <dt>[スマートフォン]</dt>
                                <dd>
                                    <i class="ssl-table_mark imgico imgico_circle-double"></i>Android、iOS、Windows Mobile等
                                </dd>
                            </dl>
                            <p class="ssl-table_inner"><a class="btn btn_white btn_white_border" href="https://knowledge.digicert.com/jp/general-information/ssl-certificates-browser-smartphone-compatibility-after-december-2017" target="_blank" rel="nofollow">その他OSや端末の対応状況<i class="ico ico_new-window"></i></a></p>
                        </td>
                    </tr>
                </table>
                <!-- /.ssl-table -->
                    ...
                    <div class="block_body">
                        ...
                        <table class="table yearPriceTable primary-table-l">
                            ...
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">84,700円</div><span class="numYears__price--num">67,760</span>円</div><div class="numYears__period">×1年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">84,700円</div><span class="numYears__price--num">67,760</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">81,400円</div><span class="numYears__price--num">65,120</span>円</div><div class="numYears__period">×2年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">162,800円</div><span class="numYears__price--num">130,240</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">80,300円</div><span class="numYears__price--num">64,240</span>円</div><div class="numYears__period">×3年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">240,900円</div><span class="numYears__price--num">192,720</span>円</div></div></td>
                            </tr>
                            </tbody>
                        </table>
                        <p class="note mb5">
                ...
                <section class="block">
                    ...
                    <div class="block_body">
                        ...
                        <table class="table yearPriceTable primary-table-l">
                            ...
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">1</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">84,700</span>円</div><div class="numYears__period">×1年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">84,700</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">2</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">81,400</span>円</div><div class="numYears__period">×2年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">162,800</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">3</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">80,300</span>円</div><div class="numYears__period">×3年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">240,900</span>円</div></div></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
