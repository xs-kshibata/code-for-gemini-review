...
<title>ジオトラスト クイックSSLプレミアム - 独自SSL | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="ジオトラスト クイックSSLプレミアムの仕様詳細とご利用料金に関するご案内です。">
        ...
        <div class="ssl-brand">
            <div class="ssl-brand-header clearfix">
                <div class="ssl-brand-header_r">
                    <img src="../../img/functions/img_logo_geotrust.png" alt="ジオトラスト">
                </div>
                <div class="ssl-brand-header_l">
                    <h3 class="ssl-brand-header_ttl">ジオトラスト クイックSSLプレミアム</h3>
                    ...
                    <p>世界的にシェアの高いジオトラストが運営するSSL証明書です。<br>
                    モバイルへの高い対応率を誇ります。</p>
                </div>
            </div>
            ...
            <div class="ssl-brand-price">
                <div class="ssl-brand-price_more">
                    <dl class="pr-price"><dt>年額</dt><dd><span>14,300</span>円(税込)〜
                            <span class="cpPrice">キャンペーン価格：11,440円〜※</span></dd></dl>
                </div>
            </div>
            <p class="note font-s mb30">※2025年4月30日12:00 - 2025年9月30日17:00までのキャンペーン価格です。</p>
            
            <div class="ssl-brand-feature">
                <h4 class="ssl-brand-feature_ttl">ジオトラスト クイックSSLプレミアムの特長</h4>
                <div class="ssl-brand-feature_pr clearfix">
                    <ul>
                        ...
                        <li><dl><dt><img src="../../img/functions/ico_ssl_world.png" alt=""></dt><dd><b>世界的にも有名！</b><br>ジオトラストの事業部が運営のSSLブランドです。</dd></dl></li>
                    </ul>
                </div>
            </div>
        ...
        <section class="section">
            ...
            <div class="section_body">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>サイトシール</th>
                        <td><img src="../../img/functions/img_siteseal_geotrust.png" alt="ジオトラスト サイトシールサンプル"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <dl class="ssl-table_dl">
                                ...
                                <dd>
                                    <i class="ssl-table_mark imgico imgico_circle"></i>
                                    IE:6以降、Firefox:1.0以降、GoogleChrome:1.0以降、Safari:2.0以降
                                </dd>
                            </dl>
                            <dl class="ssl-table_dl">
                                <dt>[スマートフォン]</dt>
                                <dd>
                                    <i class="ssl-table_mark imgico imgico_circle-double"></i>Android:1.5以降、iOS:2.0以降
                                </dd>
                            </dl>
                            <p class="ssl-table_inner"><a class="btn btn_white btn_white_border" href="https://www.geotrust.co.jp/products/sha2-migration.html" target="_blank" rel="nofollow">その他OSや端末の対応状況<i class="ico ico_new-window"></i></a></p>
                        </td>
                    </tr>
                </table>
                <!-- /.ssl-table -->
                    ...
                    <div class="block_body">
                        ...
                        <table class="table yearPriceTable primary-table-l">
                            ...
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">15,400円</div><span class="numYears__price--num">12,320</span>円</div><div class="numYears__period">×1年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">15,400円</div><span class="numYears__price--num">12,320</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">14,850円</div><span class="numYears__price--num">11,880</span>円</div><div class="numYears__period">×2年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">29,700円</div><span class="numYears__price--num">23,760</span>円</div></div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price red"><div class="normalPrice">14,300円</div><span class="numYears__price--num">11,440</span>円</div><div class="numYears__period">×3年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price red"><div class="normalPrice">42,900円</div><span class="numYears__price--num">34,320</span>円</div></div></td>
                            </tr>
                            </tbody>
                        </table>
                        <p class="note mb5">
                ...
                <section class="block">
                    ...
                    <div class="block_body">
                        ...
                        <table class="table yearPriceTable primary-table-l">
                            ...
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">1</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">15,400</span>円</div><div class="numYears__period">×1年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">15,400</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">2</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">14,850</span>円</div><div class="numYears__period">×2年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">29,700</span>円</div></div></td>
                            </tr>
                            <tr>
                                <td><div class="numYears"><div class="numYears__caption">契約期間</div><div class="numYears__term"><span class="numYears__term--num">3</span>年</div></div> </td>
                                <td><div class="numYears"><div class="numYears__caption">SSL証明書料（年額）</div><div class="numYears__price"><span class="numYears__price--num">14,300</span>円</div><div class="numYears__period">×3年</div></div></td>
                                <td><div class="numYears fr"><div class="numYears__caption">合計</div><div class="numYears__price"><span class="numYears__price--num">42,900</span>円</div></div></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
