...
<meta property="og:title" content="【終了いたしました】SecureCore半額キャンペーン！＜2021年2月17日(水) 〜 2021年3月31日(水)まで＞">
<meta property="og:type" content="website">
<meta property="og:description" content="エックスサーバーのキャンペーンページです。SecureCore半額キャンペーンの詳細をご案内しています。＜2021年2月17日(水) 〜 2021年3月31日(水)まで＞">
<meta property="og:url" content="<?php print $SITE_URL; ?>campaign/campaign_210217.php">
<meta property="og:image" content="<?php print $SITE_URL; ?>img/campaign/210217/ogp.png">
...
<title>【終了いたしました】SecureCore半額キャンペーン！＜2021年2月17日(水) 〜 2021年3月31日(水)まで＞ | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="SecureCore半額キャンペーン！！ - <?php print $SITE_DESCRIPTION; ?>">
</head>
    ...
    <section class="main holder-sml" role="main">
        ...
        <section class="campaign">
            <h2 class="campaign_visual mb15">
                <img src="<?php print_fileURL("img/campaign/210217/campaign_top_img.png"); ?>" alt="SecureCore半額キャンペーン！！">
            </h2>
            ...
            <section class="cp-flow">
                ...
                <div class="cp-flow_unit">
                    ...
                    <p>証明書のお申し込みには<a href="<?php print $SECURE_URL; ?>xinfo/?action_register_server2_index=on&service=xserver" target="_blank">『エックスサーバー』のサーバー契約</a>が必要です。<br>※「企業認証SSL」「EV SSL」は法人向けレンタルサーバーサービス<a href="<?php print $XBIZ_URL; ?>" target="_blank">『エックスサーバービジネス』</a>でご利用可能です。</p>
                </div>
                <div class="cp-flow_unit">
            ...
            <table class="campaign_table">
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner">
                            <p class="font-l font-bold">キャンペーン期間中に、新規にお申し込みいただいた「SecureCore ドメイン認証SSL」「SecureCore 企業認証SSL※」「SecureCore EV SSL※」</p>
                            <p class="font-s">※「SecureCore 企業認証SSL」「SecureCore EV SSL」はエックスサーバービジネスのみでご利用可能な証明書です</p>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner">
                            <p>
                                <s>2021年2月17日(水)12:00 〜 2021年3月31日(水)18:00まで</s><br>
                ...
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner">
                            <p><strong class="font-l bright-yellow">期間中、各種SSL証明書料がお得に！</strong></p>
                            <div class="border border_yellow">
                                <p>
                                    ○SecureCore ドメイン認証SSL<br>
                                    　<s>18,000円</s> <strong class="font-l red">9,000円(税抜)</strong><br>
                                </p>
                                <p>
                                    ○SecureCore 企業認証SSL<br>
                                    　<s>38,000円</s> <strong class="font-l red">19,000円(税抜)</strong><br>
                                </p>
                                <p>
                                    ○SecureCore EV SSL<br>
                                    　<s>96,000円</s> <strong class="font-l red">48,000円(税抜)</strong><br>
                                </p>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner">
                            <p class="note mb5">※キャンペーン期間中に新規にお申し込みいただいたSSL証明書が対象となります。<br>
                                キャンペーン期間外にお申し込みいただいたSSL証明書のご利用料金のお支払いをキャンペーン期間中に行いましても、キャンペーンは適用されませんのでご注意ください。</p>
                            <p class="note mb0">
                                ※キャンペーン価格の適用は1年目のご利用料金が対象です。2年目以降は通常料金が適用されます。
                            </p>
                        </div>
                    </td>
                </tr>
        ...
        <section class="cp-btnset">
            ...
            <div class="cp-btnset_body clearfix">
                <div class="cp-btnset_unit cp-btnset_unit-dv">
                    <h4 class="cp-btnset_unit_ttl">「ドメイン認証SSL」をご利用の方</h4>
                    <p>下記リンクからXServerアカウントへログイン後、SSL証明書の追加お申し込みを行ってください。</p>
                    <p><a class="btn btn_orange-l" href="<?php print $SECURE_URL; ?>xapanel/login/xserver/" target="_blank">独自SSLのお申し込みはこちらから<i class="ico ico_new-window"></i></a></p>
                </div>
                <div class="cp-btnset_unit cp-btnset_unit-ovev">
                    <h4 class="cp-btnset_unit_ttl">「企業認証SSL」「EV SSL」をご利用の方</h4>
                    <p>法人向けレンタルサーバーサービス<br>『エックスサーバービジネス』でのみご利用可能です。</p>
                    <p><a class="btn" href="<?php print $XBIZ_URL; ?>" target="_blank"><img src="../img/campaign/btn_xbiz.png" alt="法人向けレンタルサーバー　エックスサーバービジネス" class="flex" /></a></p>
                </div>
            </div>
