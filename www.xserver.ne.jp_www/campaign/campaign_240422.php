...
// キャンペーン情報
$name = '【終了いたしました】SSL証明書 半額キャッシュバックキャンペーン';
$date = '2024年4月22日(月) 12:00〜2024年7月22日(月) 12:00まで';
$date_brackets = '＜' . $date. '＞';
$id = '240422';
?>
<!DOCTYPE html>
            ...
            <div class="holder-sml">
                ...
                <table class="campaign_table">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="campaign_table_inner">
                                <em class="font-l font-bold bright-yellow">1年契約時の初回お支払い額の《半額》をキャッシュバック</em>
                                <p class="mb15">
                                    キャッシュバック金額は以下のとおりです。
                                </p>
                                <ul class="list list_margin list_arrow-right ml35">
                                    <li>
                                        ...
                                        <p><span class="font-bold bright-yellow">9,900円</span> キャッシュバック</p>
                                    </li>
                                    <li>
                                        <b>クラウドセキュア 企業認証SSL</b>
                                        <p><span class="font-bold bright-yellow">20,900円</span> キャッシュバック</p>
                                    </li>
                                    <li>
                                        <b>クラウドセキュア EV SSL</b>
                                        <p><span class="font-bold bright-yellow">52,800円</span> キャッシュバック</p>
                                    </li>
                                    <li>
                                        <b>ジオトラスト クイックSSLプレミアム</b>
                                        <p><span class="font-bold bright-yellow">7,700円</span> キャッシュバック</p>
                                    </li>
                                    <li>
                                        <b>デジサート セキュア・サーバID</b>
                                        <p><span class="font-bold bright-yellow">37,950円</span> キャッシュバック</p>
                                    </li>
                                </ul>
                            </div>
                        </td>
