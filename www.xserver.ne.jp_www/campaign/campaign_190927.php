...
<meta property="og:title" content="サーバー初期設定費用半額キャンペーン！＜2019年9月27日(金) 〜 2019年10月10日(木)まで＞">
<meta property="og:type" content="website">
<meta property="og:description" content="エックスサーバーのキャンペーンページです。サーバー初期設定費用半額キャンペーンの詳細をご案内しています。＜2019年9月27日(金) 〜 2019年10月10日(木)まで＞">
<meta property="og:url" content="<?php print $SITE_URL; ?>campaign/campaign_190927.php">
<meta property="og:image" content="<?php print $SITE_URL; ?>img/campaign/190927/ogp.png">
...
<title>【終了いたしました】サーバー初期費用半額キャンペーン！＜2019年9月27日(金) 〜 2019年10月10日(木)まで＞ | <?php print $SITE_TITLE; ?></title>
<meta name="description" content="サーバー初期費用半額キャンペーン！ - <?php print $SITE_DESCRIPTION; ?>">
...
<div class="contents">
    ...
    <section class="main holder-sml mb0" role="main">
    
        <section class="campaign">
            <h2 class="campaign_visual"><img src="../img/campaign/190927/campaign_top_img.png?date=191010" alt="サーバー初期費用半額キャンペーン！"></h2>
            ...
            <table class="campaign_table">
                ...
                <tr>
                	...
                	<td>
                        <div class="campaign_table_inner">
                            <p>
                                <s>2019年9月27日(金)12:00 〜 2019年10月10日(木)18:00まで</s>
                                <br>
                	...
                	<td>
                        <div class="campaign_table_inner">
                            <p class="font-l font-bold bright-yellow">
                                期間中、通常3,000円(税抜)のサーバー初期設定費用が、半額の1,500円(税抜)
                            </p>
                        </div>
                	</td>
                </tr>
                <tr>
                	...
                	<td>
                        <div class="campaign_table_inner">
                            <p class="note mb0">※キャンペーン期間中にお申し込みのサーバーアカウントが対象となります。</p>
                            <p class="note mb0">※キャンペーン期間外にお申し込みいただいたサーバーアカウントのご利用料金のお支払いをキャンペーン期間中に行いましても、キャンペーン適用はされませんのでご注意ください。</p>
                        </div>
                	</td>
                </tr>
            </table>
