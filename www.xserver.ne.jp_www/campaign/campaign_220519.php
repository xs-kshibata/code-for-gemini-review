...
// キャンペーン情報
$name = '【終了いたしました】SecureCore複数年分まとめ買い割キャンペーン';
$date = '2022年5月19日(木) 18:00 〜 2022年9月27日(火) 12:00まで';
$date_brackets = '＜' . $date. '＞';
$id = '220519';
?>
<!DOCTYPE html>
...
<meta property="og:image" content="<?php print $SITE_URL; ?>img/campaign/<?php print $id; ?>/ogp.png?date=<?php print $id; ?>02">
                        ...
                        <td>
                            <div class="campaign_table_inner">
                                ...
                                <div class="border border_yellow">
                                    <p class="fontBold mb5"><b>＜SecureCore ドメイン認証SSL＞</b></p>
                                    <p class="mb5"><b class="red">3年以上ご契約で【17,600円】お得！</b></p>
                                    <ul class="campaign_table_inner_list mb20">
                                        <li>3年契約　<s>52,800円</s>　→　<b class="red">35,200円</b></li>
                                        <li>4年契約　<s>66,000円</s>　→　<b class="red">48,400円</b></li>
                                        <li>5年契約　<s>77,000円</s>　→　<b class="red">59,400円</b></li>
                                    </ul>

                                    <p class="fontBold mb5"><b>＜SecureCore 企業認証SSL＞</b></p>
                                    <p class="mb5"><b class="red">3年以上ご契約で【36,300円】お得！</b></p>
                                    <ul class="campaign_table_inner_list mb20">
                                        <li>3年契約　<s>108,900円</s>　→　<b class="red">72,600円</b></li>
                                        <li>4年契約　<s>140,800円</s>　→　<b class="red">104,500円</b></li>
                                        <li>5年契約　<s>165,000円</s>　→　<b class="red">128,700円</b></li>
                                    </ul>

                                    <p class="fontBold mb5"><b>＜SecureCore EV SSL＞</b></p>
                                    <p class="mb5"><b class="red">3年以上ご契約で【93,500円】お得！</b></p>
                                    <ul class="campaign_table_inner_list mb20">
                                        <li>3年契約　<s>280,500円</s>　→　<b class="red">187,000円</b></li>
                                        <li>4年契約　<s>356,400円</s>　→　<b class="red">262,900円</b></li>
                                        <li>5年契約　<s>418,000円</s>　→　<b class="red">324,500円</b></li>
                                    </ul>
                                </div>
                            </div>
                        </td>
