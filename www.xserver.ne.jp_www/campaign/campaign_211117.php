...
// キャンペーン情報
$name = '【終了いたしました】XServer SSL リリース記念キャンペーン';
$date = '2021年11月17日(水) 12:00〜2022年4月21日(木) 18:00まで';
$date_brackets = '＜' . $date. '＞';
$id = '211117';
?>
<!DOCTYPE html>
...
<meta property="og:description" content="エックスサーバーのキャンペーンページです。XServer SSL リリース記念キャンペーンの詳細をご案内しています。<?php print $date_brackets; ?>">
        ...
        <section class="campaign">
            ...
            <table class="campaign_table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner">
                            <p><strong class="font-l bright-yellow">全てのSSL証明書において、お支払い金額より最大30%OFF！</strong><br>
                            価格や詳細については、以下のSSL証明書のページよりご確認ください。</p>
                            <div class="border border_yellow">
                                <p class="font-bold mb5 red">≪ 30%OFF！ ≫</p>
                                <ul class="campaign_table_inner_list">
                                    <li><a href="../functions/ssl/securecore.php">SecureCore ドメイン認証SSL</a></li>
                                    <li><a href="../functions/ssl/securecore_ov.php">SecureCore 企業認証SSL</a></li>
                                    <li><a href="../functions/ssl/securecore_ev.php">SecureCore EV SSL</a></li>
                                </ul>

                                <p class="font-bold mb5 red">≪ 5%OFF！ ≫</p>
                                <ul class="campaign_table_inner_list">
                                    <li><a href="../functions/ssl/coressl.php">CoreSSL</a></li>
