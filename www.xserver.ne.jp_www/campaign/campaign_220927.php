...
// キャンペーン情報
$name = '【終了いたしました】SecureCore SSL半額キャッシュバックキャンペーン';
$date = '2022年9月27日(火) 12:00 〜 2022年11月24日(木) 12:00まで';
$date_brackets = '＜' . $date. '＞';
$id = '220927';
?>
<!DOCTYPE html>
            ...
            <div class="holder-sml">
                ...
                <table class="campaign_table">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="campaign_table_inner">
                                <em class="font-l font-bold bright-yellow">初回お支払い時のご利用料金を《半額》キャッシュバック！</em>
                                <p class="mb0 ml10">
                                ...
                                <ul class="list list_margin list_arrow-right ml35">
                                    <li>
                                        <b>SecureCoreドメイン認証SSL</b>
                                        <p>1年契約・・・<span class="font-bold bright-yellow">9,900円</span> キャッシュバック<br>
                                           2年契約・・・<span class="font-bold bright-yellow">18,700円</span> キャッシュバック<br>
                                           3年契約・・・<span class="font-bold bright-yellow">26,400円</span> キャッシュバック<br>
                                           4年契約・・・<span class="font-bold bright-yellow">33,000円</span> キャッシュバック<br>
                                           5年契約・・・<span class="font-bold bright-yellow">38,500円</span> キャッシュバック
                                        </p>
                                    </li>
                                    <li>
                                        <b>SecureCore企業認証SSL</b>
                                        <p>1年契約・・・<span class="font-bold bright-yellow">20,900円</span> キャッシュバック<br>
                                           2年契約・・・<span class="font-bold bright-yellow">38,500円</span> キャッシュバック<br>
                                           3年契約・・・<span class="font-bold bright-yellow">54,450円</span> キャッシュバック<br>
                                           4年契約・・・<span class="font-bold bright-yellow">70,400円</span> キャッシュバック<br>
                                           5年契約・・・<span class="font-bold bright-yellow">82,500円</span> キャッシュバック
                                        </p>
                                    </li>
                                    <li>
                                        <b>SecureCore EV SSL</b>
                                        <p>1年契約・・・<span class="font-bold bright-yellow">52,800円</span> キャッシュバック<br>
                                           2年契約・・・<span class="font-bold bright-yellow">99,000円</span> キャッシュバック<br>
                                           3年契約・・・<span class="font-bold bright-yellow">140,250円</span> キャッシュバック<br>
                                           4年契約・・・<span class="font-bold bright-yellow">178,200円</span> キャッシュバック<br>
                                           5年契約・・・<span class="font-bold bright-yellow">209,000円</span> キャッシュバック
                                        </p>
                                    </li>
                                </ul>
                            </div>
