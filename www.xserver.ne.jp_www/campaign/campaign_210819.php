...
<meta property="og:title" content="SecureCore半額キャンペーン！＜2021年8月19日(木) 〜 2021年9月16日(木)まで＞">
<meta property="og:type" content="website">
<meta property="og:description" content="エックスサーバーのキャンペーンページです。SecureCore半額キャンペーンの詳細をご案内しています。＜2021年8月19日(木) 〜 2021年9月16日(木)まで＞">
<meta property="og:url" content="<?php print $SITE_URL; ?>campaign/campaign_210819.php">
<meta property="og:image" content="<?php print $SITE_URL; ?>img/campaign/210819/ogp.png?date=210819">
...
<title>【終了いたしました】SecureCore半額キャンペーン！＜2021年8月19日(木) 〜 2021年9月16日(木)まで＞ | <?php print $SITE_TITLE; ?></title>
    ...
    <section class="main holder-sml" role="main">
        ...
        <section class="campaign">
            <h2 class="campaign_visual mb15">
                <img src="<?php print_fileURL("img/campaign/210819/campaign_top_img.png"); ?>" alt="SecureCore半額キャンペーン！！">
            </h2>
            <p class="note">※特定のURLを起点とした既定のページ数の診断を毎日行います。詳細は<a href="https://www.securecore.co.jp/" target="_blank">SecureCore公式サイト</a><i class="ico ico_new-window"></i>をご確認ください。</p>
            ...
            <table class="campaign_table">
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner">
                            <p class="font-l font-bold">キャンペーン期間中に、新規にお申し込みいただいた「SecureCore ドメイン認証SSL」</p>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner">
                            <p>
								<s>2021年8月19日(木)12:00 〜 2021年9月16日(木)18:00まで</s><br>
                ...
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner">
                            <p><strong class="font-l bright-yellow">期間中、サーバーアカウントごとに初回だけ新規にお申し込みいただいたドメイン認証SSL証明書料がお得に！</strong></p>
                            <div class="border border_yellow">
                                <p>
                                    ○SecureCore ドメイン認証SSL<br>
                                    　<s>19,800円</s> <strong class="font-l red">9,900円</strong><br>
                                </p>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner">
                            <p class="note mb5">※キャンペーン期間中にサーバーアカウントごとに初回だけ新規にお申し込みいただいたSSL証明書が対象となります。<br>
                            ...
                            <p class="note mb0">
                                ※すでにSecureCoreドメイン認証SSLをご利用のサーバーアカウントについては通常料金が適用されます。
                            </p>
                        </div>
                    </td>
                </tr>
