...
<meta property="og:title" content="サーバー初期設定費用半額キャンペーン！＜2019年7月5日(金) 〜 2019年7月25日(木)まで＞">
<meta property="og:type" content="website">
<meta property="og:description" content="エックスサーバーのキャンペーンページです。サーバー初期設定費用半額キャンペーンの詳細をご案内しています。＜2019年7月5日(金) 〜 2019年7月25日(木)まで＞">
<meta property="og:url" content="<?php print $SITE_URL; ?>campaign/campaign_190705.php">
<meta property="og:image" content="<?php print $SITE_URL; ?>img/campaign/190705/ogp.png">
...
<title>【終了いたしました】サーバー初期費用半額キャンペーン！＜2019年7月5日(金) 〜 2019年7月25日(木)まで＞ | <?php print $SITE_TITLE; ?></title>
...
<div class="contents">
    ...
    <section class="main holder-sml mb0" role="main">
        ...
        <section class="campaign">
            <h2 class="campaign_visual"><img src="../img/campaign/190705/campaign_top_img.png?date=190725" alt="サーバー初期費用半額キャンペーン！"></h2>
            ...
            <table class="campaign_table">
                ...
                <tr>
                	...
                	<td>
                        <div class="campaign_table_inner">
                            <p>
                                <s>2019年7月5日(金)12:00 〜 2019年7月25日(木)18:00まで</s>
                                <br>
