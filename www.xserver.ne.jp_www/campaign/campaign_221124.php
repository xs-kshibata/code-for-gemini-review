...
// キャンペーン情報
$name = '【終了いたしました】SSL証明書 最大30%OFFキャンペーン';
$date = '2022年11月24日(木) 12:00〜2023年4月6日(木) 12:00まで';
$date_brackets = '＜' . $date. '＞';
$id = '221124';
?>
<!DOCTYPE html>
        ...
        <section class="campaign">
            ...
            <table class="campaign_table">
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner font-bold font-l">
                            <p class="mb5">期間中、新規にお申し込みいただいた対象のSSL証明書(全契約期間対象)</p>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="campaign_table_inner">
                            <p><strong class="font-l bright-yellow">対象のSSL証明書において、お支払い金額より最大30%OFF！</strong><br>
