...
var ga_setClickEvent = function(){
    ...
    $('#ga-functionBnrClick-campaign220728').on('click.ga_setClickEventTop', function(){
        $(this).off('click.ga_setClickEventTop');
        gtag('event', 'click', {
            'event_category': 'campaign',
            'event_label': 'function_bnrclick_campaign220728'
        });
    });

    // キャンぺ - LP誘導バナー - price
    $('#ga-priceBnrClick-campaign220728').on('click.ga_setClickEventTop', function(){
        $(this).off('click.ga_setClickEventTop');
        gtag('event', 'click', {
            'event_category': 'campaign',
            'event_label': 'price_bnrclick_campaign220728'
        });
    });

    // キャンぺ - 応募バナー - LP内
    $('#ga-lpApplyBnrClick-campaign220728').on('click.ga_setClickEventTop', function(){
        $(this).off('click.ga_setClickEventTop');
        gtag('event', 'click', {
            'event_category': 'campaign',
            'event_label': 'apply_bnrclick_campaign220728'
        });
    });
};
...
var ga_setClickEventTop = function(){
    ...
    // キャンぺ - LP誘導バナー - TOP
    $('#ga-topBnrClick-campaign220728').on('click.ga_setClickEventTop', function(){
        $(this).off('click.ga_setClickEventTop');
        gtag('event', 'click', {
            'event_category': 'campaign',
            'event_label': 'top_bnrclick_campaign220728'
        });
    });
