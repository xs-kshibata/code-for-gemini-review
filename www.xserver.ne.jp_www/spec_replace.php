...
<meta name="description" content="レンタルサーバー「エックスサーバー」の旧仕様のサーバー（サーバー移行メンテナンス前)を対象とする最新サーバー環境への移行メンテナンスにおいて、サービス仕様の主な変更点についてご案内しています。">
    ...
    <article class="article">
        ...
        <div class="article_body">
            <p>
                ...
                このメンテナンス作業により変更する提供仕様について、ご案内いたします。
            </p>
            ...
            <p class="border border_blue">
            	参考リンク<br>
                　2018/10/22：<br>　　<a href="https://www.xserver.ne.jp/support/faq/faq_service_maintenance.php">新サーバーの移行メンテナンスに関するよくある質問</a><br>
                　2017/10/30：<br>　　<a href="https://www.xserver.ne.jp/news_detail.php?view_id=3718">『sv1〜sv1999サーバー』ハードウェアの大幅増強および最新サーバー環境への移行に関するご案内</a><br>
            ...
            <p class="tar">※サーバー番号の確認方法は<a href="support/faq/faq_service_server.php#13">こちら</a>をご参照ください。</p>
                ...
                <table class="diff table primary-table-ml">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <p>PHPバージョンは、ドメインごとに選択が可能です。<br>
                                    移行後は、任意のディレクトリごとに異なるPHPバージョンを利用することはできなくなります。</p>
                                <p>PHP 4.3.xをご利用の場合、移行後は「PHP 4.4.x」になります。</p>
                            </td> 
                        </tr>
                        <tr>
                ...
                <table class="diff table primary-table-ml">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><p>「MySQL 5.0」と「MySQL 5.5」のデータベースは、「MariaDB 5.5」に移行いたします。</p>
                                <p class="note">※移行によるMySQLホスト名の変更は、ありません。</p></td>
                        </tr>
                        <tr>
                ...
                <table class="diff table primary-table-ml">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>移行後のサーバーでは、Xoops Cube Legacyの自動インストール機能を提供しておりません。</td>
                        </tr>
                        <tr>
                ...
                <table class="diff table primary-table-ml">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>移行後のコマンドパスは以下のマニュアルをご参照ください。</p>
                                <a class="btn btn_white" href="manual/man_program_soft.php">プログラム言語・コマンドパス<i class="ico ico_chevron-right"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="diff table primary-table-ml">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>提供なし</td>
                            <td>
                            	<p>既に追加済みのSSL用アドレスは、引き続きご利用いただけます。</p>
                            </td>
                        </tr>
                        <tr>
