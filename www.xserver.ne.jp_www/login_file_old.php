...
<title>旧ファイルマネージャ - ログイン | <?php print $SITE_TITLE; ?></title>
...
<?php include("subnav.php"); ?>
        ...
        <section class="login webftp">
            ...
            <div class="loginHeader">
                <h3 class="loginHeader__ttl login__ttl--info">旧ファイルマネージャ  ログイン</h3>
            ...
            <div class="newLogin">
                ...
                <div class="newLogin_btn btnarea">
                    <a class="btn" href="<?php print $SECURE_URL; ?>xapanel/login/xserver/ftpold" target="_blank">新ログインフォームに切替</a>
                </div>
            </div>
            ...
            <form id="login_area" action="<?php print $SECURE_URL; ?>xinfo/loginwebftp.cgi" method="POST">
                ...
                <p class="tac" style="color:red; font-weight:bold">※こちらは旧デザインのファイルマネージャへのログイン画面です。一定期間後に閲覧できなくなります。</p>
                <div class="btnarea">
                    ...
                    <input type="hidden" value="true" name="old">
                </div>
                <p class="tac">※新デザインのファイルマネージャは<a href="<?php print $SECURE_URL; ?>xapanel/login/xserver/ftp/" target="_blank" rel="noopener">こちら</a></p>
            </form>
