...
<meta name="description" content="ネームサーバーとは、対象のドメインをどのサーバーで使用するか決定するためのアドレス、とお考えください。エックスサーバーで独自ドメインを使用するためには、ドメインのネームサーバーをエックスサーバー指定のものに変更していただく…">
...
<?php include("../subnav.php"); ?>
        ...
        <div class="clearfix">
            ...
            <section class="col-main">
                ...
                エックスサーバーで独自ドメインを使用するためには、ドメインのネームサーバーをエックスサーバー指定のものに変更していただく必要があります。</p>
