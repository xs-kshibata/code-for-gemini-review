...
<title>自分のホームページからウィルスが検出されました。 - よくある質問 | <?php print $SITE_TITLE; ?></title>
...
<?php include("../subnav.php"); ?>
        ...
        <div class="clearfix">
            ...
            <section class="col-main">
                ...
                <h3 class="sub-ttl">自分のホームページからウィルスが検出されました。</h3>
                    ...
                    <dd>
                        ...
                        <ol class="ol ol_margin mb0">
                            ...
                            <li>
                                ...
                                <p class="note">※サーバーIDのパスワードとメインFTPパスワードは同一のため、メインFTPパスワードも同時に変更されます。</p>
                            </li>
                            <li>サーバー上の必要なサイトデータ・メールデータを全て保存した上でサーバーパネルよりドメイン設定を全て削除してください。<br>
                                またFTPソフトにて、初期ドメイン上の全てのファイルを削除してください。
                            </li>
                            <li>サーバーパネルより再度ドメイン設定をし、ホームページのファイルをアップロードを行ってください。<br>
